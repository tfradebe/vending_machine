...
public class ProductServiceTest {
    ...
    public void find_all(){
        when(productRepo.findAll()).thenReturn(List.of(new ProductEntity(1L, "Product1", 5.5, 5),new ProductEntity(2L, "Product2", 5.5, 5)));
        when(productMapper.map(anyList())).thenReturn(List.of(new ProductDao(1L, "Product1", 5.5, 5),new ProductDao(2L, "Product2", 5.5, 5)));
    ...
    public void checkout_success(){
        when(productRepo.findAllAsMap()).thenReturn(Map.of(1L,new ProductEntity(1L, "Product1", 5.5, 5),2L,new ProductEntity(2L, "Product2", 5.5, 5)));
